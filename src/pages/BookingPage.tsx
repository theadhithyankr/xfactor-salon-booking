    ...
    const checkAvailability = async () => {
        ...
        if (selectedSalon.opening_time && selectedSalon.closing_time) {
            ...
            if (timeStr < opening || endTime > closing) {
                ...
                showNotification(`Please select a time range between ${open12} and ${close12}. Your total service time is ${totalDuration} mins.`, 'warning');
                return false;
            }
        }
        ...
        if (selectedWorker) {
            ...
            if (conflicts && conflicts.length > 0) {
                showNotification('This professional is already booked at this time. Please choose another slot.', 'warning');
                return false;
            }
